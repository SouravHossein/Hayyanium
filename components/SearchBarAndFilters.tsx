    ...
    <div className="p-4 bg-gray-800 rounded-lg">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <input
          ...
          className="md:col-span-2 p-2 rounded-md bg-gray-700 text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-cyan-400"
        />
        <select
          value={filters.category}
          onChange={(e) => onFilterChange('category', e.target.value)}
          className="p-2 rounded-md bg-gray-700 text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-cyan-400 capitalize"
        >
      ...
      <div className="mt-4 flex justify-end">
          <button onClick={onClear} className="px-4 py-2 bg-gray-600 hover:bg-gray-500 rounded-md text-sm font-semibold">Clear Filters</button>
      </div>
    </div>
  );
};
